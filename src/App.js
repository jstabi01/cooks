	...
	return (
		<div
			...
			<div
				...
				<RecipeCard
					recipe="Avacado Black Bean Salad"
					src={avacado}
					ingredients={
						<ul>
					...
					directions={
						<ol>
							...
							<li>
								While Quiona cooks add frozen corn in a
								non-stick pan with olive oil until tender.
							</li>
							<li>
								In a large bowl mix Lime Juice, Honey, Chilis,
								Cilantro, Salt, and Pepper.
							</li>
							<li>
								Add in Chopped Tomatoes, Green Onion, Black
								Beans, Cubed Avacado and Corn.
							</li>
				...
				<RecipeCard
					...
					directions={
						<ol>
							...
							<li>
								Add veggies of choice to pan seasoning with
								minced garlic and cocount aminos (or soy sauce)
							</li>
							<li>Set veggies aside</li>
							<li>
								Cook eggs in same pan adding more oil if
								necessary
							</li>
							<li>Add rice to a stone/glass bowl</li>
							<li>Top with veggies and egg</li>
							<li>
								Add gocujang sauce, kimchi, and any other
								desired toppings
							</li>
							<li>Mix and enjoy</li>
						</ol>
				...
				<RecipeCard
					...
					directions={
						<ol>
							<li>Preheat oven to 400 C.</li>
							<li>
								Mix curry powder, salt, and olive oil in a large
								bowl. Add chopped carrots and onions and toss to
								coat.
							</li>
							<li>
								Add vegetables to a cooking sheet and bake until
								tender. 30 to 40 mins.
							</li>
							<li>
								Remove from baking sheet into a large pot and
								add coconut oil as well as vegetable broth.
								Simmer for a few minutes.
							</li>
							<li>Transfer to blender and blend until smooth.</li>
							<li>Transfer back to pot and warm to serve.</li>
						</ol>
					}
				/>
				<RecipeCard
					...
					directions={
						<ol>
							...
							<li>
								Stir in Onion, Bay Leaves, Cumin, Oregano, and
								Salt. Cook until onion is tender.
							</li>
							<li>
								Mix in Celery, Bell Peppers, Garlic, Chili
								Peppers. Reduce to low heat, simmer with pot
								covered for 5 mins.
							</li>
							<li>
								Mix in Tomatoes, Chili Powder, Pepper, Kidney
								Beans, Garbanzo Beans, and Black Beans.
							</li>
							<li>
								Add Quiona to pot, bring to boil, reduce to low
								heat, simmer for 45 minutes.
							</li>
							<li>Stir in corn. Cook for 5 more minutes.</li>
							<li>
								Serve topped with Avacado, Shredded Cheese, or
								as is.
							</li>
						</ol>
					}
				...
				<RecipeCard
					...
					directions={
						<ol>
							...
							<li>
								Add onions and coconut oil in pan and saute
								onions.
							</li>
							<li>
								Add in vegetables and heat covered until
								softened.
							</li>
							<li>
								Add curry powder, grated ginger, coconut milk,
								and spices, and bring to simmer..
							</li>
				...
				<RecipeCard
					...
					directions={
						<ol>
							<li>
								Cut Eggplant into small discs and salt
								generiously.
							</li>
							<li>
								Line eggplants on stacks of paper towel to
								absorb exess water. Allow to sit for 20-30
								minutes.
							</li>
							<li>
								Pat eggplant dry, brush with olive oil and bake
								at 325 until tender.
							</li>
							<li>
								Meanwhile add olive oil, chopped onion, and
								minced garlic into a sauce pan and cook on
								medium heat until onion is translucent.
							</li>
							<li>
								Add jar of tomato sauce into pan, cover and
								reduce heat to low.
							</li>
							<li>
								Prepare lasgna by layering tomato sauce,
								eggplant, cheese, until all eggplant is used.
							</li>
				...
				<RecipeCard
					...
					directions={
						<ol>
							<li>
								Cut Sweet Potato into small cubes, cover with
								oil, spice with salt and pepper. Bake at 325
								until soft.
							</li>
							<li>
								Meanwhile add 1 chopped onion and minced garlic
								into a large sauce pan on medium heat.
							</li>
							<li>
								Cook until onions are translucent, add in tomato
								sauce.
							</li>
							<li>
								Add can of black beans, lower heat, and cover.
							</li>
							<li>
								Once sweet potatoes are soft, add into the sauce
								pan and mix well.
							</li>
							<li>Add a thin layer of sauce into a glass pan.</li>
							<li>
								Scoop an equal amount of Enchilada filling into
								a tortilla and line tortillas until pan is full.
							</li>
							<li>
								Cover enchiladas with lines of enchilada sauce
				...
				<RecipeCard
					...
					directions={
						<ol>
							<li>
								Soak Cashews overnight (or 8 hours) in warm
								water.
							</li>
							<li>
							...
							<li>
								Pour ingredients into store bought pie crust.
							</li>
				...
				<RecipeCard
					...
					directions={
						<ol>
							<li>
								Toast pine nuts under a medium heat until
								golden.
							</li>
							<li>
								Combine basil, toasted pine nuts and garlic in a
								blender or food processor.
							</li>
							<li>Dribble in oil as mixing until smooth.</li>
							<li>Add cheese and process breifly.</li>
							<li>
								Prepare pasta and add in sauce, sliced roasted
								cherry tomatoes.
							</li>
				...
				<RecipeCard
					...
					directions={
						<ol>
							<li>
								Prepare Broccoli by chopping it, coating it with
								olive oil, and seasoning with salt, pepper, and
								garlic powder.
							</li>
							<li>Bake at 325 until crispy.</li>
							<li>
								Meanwhile in a large sauce pan add 1 Tbsp of
								olive oil, chopped onion, and minced garlic and
								heat over medium until onions are translucent.
							</li>
							<li>
								Add rice into the pan and mix to cover rice.
								Heat for about 5 more minutes.
							</li>
							<li>
								Add an equal amount of water to the amount of
								rice you put in including the tomato sauce.
							</li>
							<li>
								Heat covered on low heat, occasionally mixing
								until all the liquid is absorbed.
							</li>
							<li>
								Add the now cooked broccoli into the pan and mix
								well.
							</li>
							<li>
								Serve rice topped with slice avacado and cheese.
							</li>
						</ol>
					}
				/>
				<RecipeCard
					recipe="Sundried Tomato Pesto"
					src={sundried}
					ingredients={
						<ul>
					...
					directions={
						<ol>
							<li>
								Set Pasta to boil. When ready drain and add back
								into pot.
							</li>
							<li>
								Blend all ingridents in a High-Speed Blender
								until chunky but smooth.
							</li>
				...
				<RecipeCard
					...
					directions={
						<ol>
							<li>
								Rinse Quiona and prepare by adding equal volume
								of water and uncooked quiona into a large sauce
								pan.
							</li>
							<li>
								Once water is fully absorbed add into large
								bowl.
							</li>
							<li>
								Finley chop the cucumbers, tomatoes, and
								parsley.
							</li>
							<li>
								Add all ingridients into the bowl, mix well.
							</li>
				...
				<RecipeCard
					...
					directions={
						<ol>
							<li>
								Drain Tofu and slice thin, season with Salt and
								Pepper, cover with paper towels to absorb
								liquid.
							</li>
							<li>Prepare Rice.</li>
							<li>
								Meanwhile mix all other Ingredients (except
								olive oil) in a high-speed blender to make the
								sauce.
							</li>
							<li>
								Once Tofu is dry, chop into small pieces and
								coat with olive oil in a non-stick pan.
							</li>
							<li>Cook until golden brown.</li>
							<li>
								Pour prepared sauce into the tofu and cook for
								about 5-10 minutes.
							</li>
							<li>
								Once heated, serve over rice in cup of lettuce.
							</li>
						</ol>
					}
				/>
				<RecipeCard
					...
					ingredients={
						<ul>
							...
							<li>
								Mixed Veggies (mushrooms, carrots, peppers,
								green onion, etc)
							</li>
							<li>2 Cloves Garlic</li>
					...
					directions={
						<ol>
							...
							<li>
								Cut into cubes and mix into a bowl with Peanut
								Butter, Soy Sauce, Maple Syrup, Lime Juice, and
								Chili Garlic Sauce to season
							</li>
							<li>
								Heat tofu in a large pan over medium heat until
								slighly brown
							</li>
							<li>Remove from heat and set aside</li>
							<li>
								In the same pan add veggies, garlic, and ginger
								and cook covered
							</li>
							<li>Return tofu to pan and mix for 1-2 mins</li>
							<li>
								Place ingridents over rice, add cilantro if
								desired and serve
							</li>
						</ol>
					}
				...
				<RecipeCard
					...
					directions={
						<ol>
							<li>
								Place Butter, chopped onions, garlic and tomato
								pase in a large sauce pan on medium heat.
							</li>
							<li>
								Cook until butter is completely melted and
								onions are transluscent.
							</li>
							<li>
								In the meantime blend the jar of San Marizino
								tomatoes, salt, pepper, chopped basil, chili
								powder, and half the can of water.
							</li>
							<li>
								Pour the blended sauce into the sauce pan,
								simmer on medium for about an hour or longer.
							</li>
							<li>
								Transfer sauce from sauce pan to a large bowl
								with cooked and drained pasta.
							</li>
							<li>
								Add about 1/3 cup of parm cheese, mix, and
								enjoy.
							</li>
						</ol>
					}
				...
				<RecipeCard
					...
					directions={
						<ol>
							<li>Preheat oven to 400 C.</li>
							<li>
								Combine tomatoes and garlic on baking sheet and
								drizzle with olive oil.
							</li>
							<li>Roast for 35 mins.</li>
							<li>
								Add tomatoes and their juices, garlic, and
								vegetable broth into a pot and simmer for 20
								mins.
							</li>
							<li>
								Transfer to a blender and blend until smooth.
							</li>
							<li>Return to pot and warm over low heat.</li>
						</ol>
					}
				/>
			</div>
